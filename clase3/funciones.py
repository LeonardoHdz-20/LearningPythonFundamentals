...
from clase2.Examen import nombre
...
# alumno_materias('Josesito', 'programacion', 'matematicas', 'ingles')

alumno_calificaciones(nombre = 'Josesito', programacion = 10, matematicas=9, ingles = 10)
